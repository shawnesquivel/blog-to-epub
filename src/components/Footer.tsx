...
const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/shawnesquivel/blog-to-epub",
    icon: (
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/shawnesquivel/",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Email",
    url: "mailto:shawn@amihanventures.ca",
    icon: (
  ...
  return (
    <footer className="w-full border-t border-gray-200 py-6 mt-12">
      <div className="max-w-4xl mx-auto px-4 flex flex-col items-center gap-4">
        ...
        <p className="text-sm text-gray-400">© {new Date().getFullYear()} Shawn Esquivel</p>
      </div>
    </footer>
  );
}
